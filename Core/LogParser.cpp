...
void LogParser::startGameSession(const std::string &currentClient, int currentGameTable, const Time &currentTime)
{
...
void LogParser::endGameSession(const std::string &currentClient, const Time &currentTime)
{
